          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <input
                  ...
                  required
                  className="w-full bg-blue-100 text-black p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-secondary"
                />
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className={`w-full ${
                  isSubmitting ? 'bg-gray-400' : 'bg-darkyellow hover:bg-yellow'
